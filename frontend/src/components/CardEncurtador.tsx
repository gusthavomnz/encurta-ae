...
function CardEncurtador() {
  ...
  return (
    <div className="w-full h-[50vh] md:w-2/3 md:h-full shrink-0 md:px-32 md:py-32 px-2 py-2 backdrop-blur-2xl">
      <div className="md:w-full md:h-full border-1 border-white/50 bg-mist-700/50 backdrop-blur-2xl justify-center items-center py-16 p-4 ">
        ...
        <button className="w-full px-4 h-10 border-2 border-white/50 rounded-2xl items-center "> 
            <p className="font-sans items-center text-xl text-white px-2 flex justify-center"> Encurtar</p>
        </button>
        </form>
      </div>
    </div>
